...
class Task extends Model
{
    protected $fillable = [
        ...
        'created_at','note','proof_image','proof_signature','barcode','quantity'
    ];

    public function order(){
        return $this->belongsTo('App\Model\Order', 'order_id', 'id')->select('id', 'customer_id','driver_id','recipient_phone','Recipient_email','task_description','auto_alloction','order_time','status','cash_to_be_collected','base_price as amount');
