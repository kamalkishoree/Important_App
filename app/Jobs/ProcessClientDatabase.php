...
class ProcessClientDatabase implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $prefence = array(array('client_id'=>$client['code'],'theme'=> 'light','distance_unit'=> 'metric','currency_id'=> 147,'language_id'=> 1,'acknowledgement_type' => 'acceptreject','time_format'=> 'DD-MM-YYYY','time_format'=> 12,'phone_number'=> '9638527410','color'=> 'red'));
        try {
