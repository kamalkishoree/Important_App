...
class ProcessClientDatabase implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $prefence = array(array('client_id'=>$client['code'],'theme'=> 'light','distance_unit'=> 'metric','currency_id'=> 147,'language_id'=> 1,'acknowledgement_type' => 'acceptreject','date_format'=> 'DD-MM-YYYY','time_format'=> 12,'map_type'=>'google','email_plan'=> 'free'));
        $auto     = array(array('client_id'=>$client['code'],'manual_allocation'=> 0,'auto_assign_logic'=> 'send_to_all','request_expiry'=> 30,'number_of_retries'=> 2,'start_radius' => 10.0,'start_before_task_time'=> 10,'increment_radius'=> 10.00,'maximum_radius'=>100.00,'maximum_batch_size'=> 10,'maximum_task_per_person'=>10,'self_assign'=>0,'maximum_cash_at_hand_per_person'=>5000));
        try {
