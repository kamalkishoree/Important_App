...
class ProcessClientDatabase implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $prefence = array(array('client_id'=>$client['code'],'theme'=> 'light','distance_unit'=> 'metric','currency_id'=> 147,'language_id'=> 1,'acknowledgement_type' => 'acceptreject','date_format'=> 'm/d/Y','time_format'=> 12,'map_type'=>'google','email_plan'=> 'free'));
