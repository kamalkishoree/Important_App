...
class ShortcodeController extends BaseController
{
    ...
    {
        $client = Client::where('is_deleted', 0)->where('code', $request->shortCode)->select('id','country_id', 'name', 'database_name', 'timezone', 'custom_domain', 'logo', 'company_name', 'company_address', 'is_blocked')->with('getCountry')->first();
