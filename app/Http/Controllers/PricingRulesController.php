...
class PricingRulesController extends Controller
{
    ...
    public function store(Request $request, $domain = '')
    {
        $data = [
            ...
            'base_price_maximum'              => $request->base_price_minimum,
            'base_duration_maximum'           => $request->base_duration_minimum,
            'base_distance_maximum'           => $request->base_distance_minimum,
            'base_waiting_maximum'            => $request->base_waiting_minimum,
            'duration_price_maximum'          => $request->duration_price_minimum,
            'waiting_price_maximum'           => $request->waiting_price_minimum,
            'distance_fee_maximum'            => $request->distance_fee_minimum,
