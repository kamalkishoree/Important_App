...
class PricingRulesController extends Controller
{
    ...
    public function store(Request $request, $domain = '')
    {
        $data = [
            ...
            'base_price_minimum'              => $request->base_price,
            'base_duration_minimum'           => $request->base_duration,
            'base_distance_minimum'           => $request->base_distance,
            'base_waiting_minimum'            => $request->base_waiting,
            'duration_price_minimum'          => $request->duration_price,
            'waiting_price_minimum'           => $request->waiting_price,
            'distance_fee_minimum'            => $request->distance_fee,

            'base_price_maximum'              => $request->base_price,
            'base_duration_maximum'           => $request->base_duration,
            'base_distance_maximum'           => $request->base_distance,
            'base_waiting_maximum'            => $request->base_waiting,
            'duration_price_maximum'          => $request->duration_price,
            'waiting_price_maximum'           => $request->waiting_price,
            'distance_fee_maximum'            => $request->distance_fee,
