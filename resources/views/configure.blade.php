                    ...
                    <div class="card-box h-100">
                        ...
                        <div class="row align-items-start">
                            <div class="col-md-12">
                                ...
                                @endphp
                                <div class="form-group d-flex justify-content-between mb-3">
                                    <label for="pharmacy_check" class="mr-2 w-50 mb-0">{{__("Hide Transportation Type Icons")}} <small class="d-block pr-5">Hide Transportation Type from Signup Form.</small></label>
