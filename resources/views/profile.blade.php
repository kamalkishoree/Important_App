...
.choose-btn .icon {margin-right: 10px;line-height: 35px;z-index: 99;}
.g-btn .icon.alAppleIcon svg path{fill: #333;}
.choose-btn {margin-bottom:15px; background: linear-gradient(90deg, #73BE42 0%, rgba(244, 221, 98, 0.75) 54.17%, #248341 100%);
box-shadow: 0px 0px 4px rgba(0, 0, 0, 0.15);border-radius: 10px;width: 100%;display: flex;color: #fff;padding: 5px 0;float: left;position: relative;justify-content: center;align-items: center;}
.choose-btn span{position: relative;z-index: 1}
.g-btn::after {content: "";position: absolute;height: 96%;width: 99%;background: #fff;left: 1px;top: 1px;border-radius: 9px;}
.choose-btn .text {z-index: 99;font-size: 10px;text-transform: uppercase;font-weight: 600;letter-spacing: 1px;line-height: 1;}
.g-btn .text {color: #777;}
.choose-btn .text strong {font-size: 16px;display: block;font-weight: 600;letter-spacing: 0;text-transform: capitalize;}
