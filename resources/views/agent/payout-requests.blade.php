                                ...
                                <div class="text-center d-flex">
                                    ...
                                    @if(isset($preferences) && $preferences->auto_payout =="1")
                                        <form method="POST" action="{{route('preference', Auth::user()->code)}}" class="d-flex">
                                            @csrf
                                            <input type="text" name="charge_percent_from_agent" id="" class="form-control" value="@if((!empty($preferences->charge_percent_from_agent))){{$preferences->charge_percent_from_agent}}@endif" placeholder="Commission Percentage">
