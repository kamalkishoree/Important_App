    ...
    <div class="row">
        ...
        <div class="col-12 alWeeklyHourPopup">
           ...
           @if($is_driver_slot == 1)
                ...
                @endif
                 @if($getAdditionalPreference['is_attendence'] == 1)
                <li class="nav-item" role="presentation">
                    <button class="get_attendence nav-link @if($is_driver_slot == 0) active @endif" id="attendence-tab" data-toggle="tab" data-eventType="attendence" data-target="#attendence" type="button" role="tab" aria-controls="attendence" aria-selected="false">Attendence</button>
                </li>
                 @endif
            </ul>
