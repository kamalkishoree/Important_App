                ...
                <div class="card-body custom_body_card">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-12 text-right btn-auto d-flex custom_top_bar">
                            ...
                            <form action="{{route('category.importDispatchSideCategory')}}" method="post">
                            @csrf
                                <input type="hidden" name="order_panel_id" value="{{app('request')->input('order_panel_id') ?? 'all'}}">
                                <button type="submit" class="btn btn-blue waves-effect waves-light"><i class="mdi mdi-plus-circle mr-1"></i> {{__("Import Inventory Side Category")}}</button>
                            </form>
                        </div>
                    </div>
