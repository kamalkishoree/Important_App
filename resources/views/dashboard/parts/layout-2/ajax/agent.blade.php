...
@else
            ...
            <div class="card no-border-radius">
                <div class="card-header ml-2" id="by1">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <span
                                class="tram_agent_online_status_{{ $item->agent_id }} {{ $item->is_available == 1 ? 'online' : 'offline' }}"
                                id="tram_agent_online_status_{{ $item->agent_id }}">
                                {{ $checkAgentActive }}
                            </span>
                        </div>
                    </div>
                ...
                <div id="collapse1" class="collapse" data-parent="#accordion-1" aria-labelledby="by1">
                    <div id="handle-dragula-left1" class="dragable_tasks ui-sortable" agentid="1" params=""
                        date="2022-11-29">
    ...
    @if ($lastPage != $page && $teams)
        <button class="form-control" id="load-more-teams" data-page="{{ $page + 1 }}"
            data-url="{{ route('dashboard.agent-teamsdata', ['page' => $page + 1]) }}">Load More</button>
    @endif
