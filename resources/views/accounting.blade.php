                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ul class="agent-list  m-0 p-0">
                                            ...
                                            <li><a href="javascript:void(0)" @if($order_analytics->order_failed > 0) class="view_analytics btn btn-primary" data-status ="failed" data-atype="prev_day" @else class="btn btn-secondary" @endif>{{ $order_analytics->order_failed }}</a></li>
                                    ...
                                    <td>
                                        ...
                                        <ul class="agent-list  m-0 p-0">
                                            ...
                                            <li><a href="javascript:void(0)" @if($order_analytics->order_failed > 0) class="view_analytics btn btn-primary" data-status ="failed" data-atype="prev_week" @else class="btn btn-secondary" @endif>{{ $order_analytics->order_failed }}</a></li>
                                    ...
                                    <td>
                                        ...
                                        <ul class="agent-list  m-0 p-0">
                                            ...
                                            <li><a href="javascript:void(0)" @if($order_analytics->order_failed > 0) class="view_analytics btn btn-primary" data-status ="failed" data-atype="prev_month" @else class="btn btn-secondary" @endif>{{ $order_analytics->order_failed }}</a></li>
